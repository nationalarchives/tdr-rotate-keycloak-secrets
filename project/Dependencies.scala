...
object Dependencies {
  ...
  lazy val awsSns = "software.amazon.awssdk" % "sns" % "2.25.64"
  lazy val awsSsm = "software.amazon.awssdk" % "ssm" % "2.25.64"
  lazy val awsEcs = "software.amazon.awssdk" % "ecs" % "2.25.64"
  lazy val circeCore = "io.circe" %% "circe-core" % circeVersion
  lazy val circeGeneric = "io.circe" %% "circe-generic" % circeVersion
  lazy val circeParser = "io.circe" %% "circe-parser" % circeVersion
  lazy val keycloakAdminClient = "org.keycloak" % "keycloak-admin-client" % "24.0.5"
